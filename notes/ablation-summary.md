...
| V23 | `SNAPSHOT` | D71 sitting-wall + D72 H=20 (frozen tree, not git) | -7.7 (+4.4) | 152.3 | 237.6 | x1-a |
| V24 | `WORKING` | D75 connect-first abort (live tree) | -7.7 (+0.0) | 152.3 | 237.6 | x1-a |
