...
| policy.cpp:OwnsInbound | ring-slot owner | facing slot among **live** stations, then that LiveId | **DERIVED** (D56) | Same angle as even-spaced StationBearing. Heartbeats hop so the roster agrees. Bisector deadband D38. Receding owner yields one live step (D35). | Unique always. D19 kept original-id ownership because stations were local; they are not anymore. |
