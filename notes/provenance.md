...
| flight.cpp:TiltSettle | `τ = max_tilt / max_body_rate` | **0.075 s** (s1) | **DERIVED** (D61) | `--dump-params` `drone.max_tilt=0.6`, `drone.max_body_rate=8` | φ = atan(a_h/g), \|φ̇\| ≤ ω. Time to max tilt from 0 is 75 ms. Not the 0.4 s D49 observed. |
